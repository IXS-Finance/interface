...
export const ClaimTab: React.FC<ClaimTabProps> = ({
  ...
  const actualClaimableAmount = useMemo(() => {
    ...
    console.log("claimableAmountNum", claimableAmountNum);
      ...
      {!showClaimPreview ? (
        <FormContentContainer>
          <ClaimRow>
            ...
            <ClaimAmount>{investingTokenSymbol} {displayableFetchedClaimableAmount}</ClaimAmount>
          </ClaimRow>
          ...
          <PreviewSection>
            ...
            <SummaryTable>
              <SummaryRow>
                ...
                <SummaryValue>{investingTokenSymbol} {displayableFetchedClaimableAmount}</SummaryValue>
              </SummaryRow>
              ...
              <SummaryRow>
                ...
                <SummaryValue>{investingTokenSymbol} {platformFee}</SummaryValue>
              </SummaryRow>
              
              <SummaryRow>
                <SummaryLabel>Service Fee</SummaryLabel>
                <SummaryValue>{investingTokenSymbol} {finalServiceFee}</SummaryValue>
              </SummaryRow>
              
              <TotalRow>
                <TotalLabel>Actual Claimable Amount</TotalLabel>
                <TotalValue>{investingTokenSymbol} {actualClaimableAmount}</TotalValue>
              </TotalRow>
            </SummaryTable>
          </PreviewSection>
