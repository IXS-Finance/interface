...
export const MULTICALL2_ADDRESSES = {
  ...
  [151]: '0x91d01475b6E7D8C61d54B9F46Da0213201BDBc99',
}
...
export const TGE_CHAINS_WITH_STAKING = ENV_SUPPORTED_TGE_CHAINS || [
  ...
  SUPPORTED_TGE_CHAINS.SEPOLIA,
  SUPPORTED_TGE_CHAINS.AVALANCHE,
  SUPPORTED_TGE_CHAINS.AVALANCHE_FUJI,
]
...
export const IXS_ADDRESS: { [key: number]: string } = {
  ...
  [8453]: isProd ? '0xFE550BfFb51EB645EA3b324D772A19AC449E92c5' : '0xb473dc4C4B7d51247c01F07A9dCB7f947D9F9389',
  [153]: '0x0aeF02d9cb4cd7a480d867ae765E6eA8D00368df',
  [151]: '0x831c4F8688C3837520261c366F5B2a19cdFC7Aa6', // mock ixs token
}
...
export const SWAP_ROUTER_ADDRESS: { [key: number]: string } = {
  ...
  [8453]: isProd ? '0x38e1B66bdfd6DF1e79567D9E4D34Febf99823Ed3' : '0x63689b716a25c01a5d02cBC50bD8d20b86405e4d',
  [153]: '0x7192cAfE75EB8A5440167fE9947F827e651FDaca',
  [151]: '0x0338acFA4F8c6Ae7EC7f8A218Bc436a6A261c874',
}
...
export const LIQUIDITY_ROUTER_ADDRESS: { [key: number]: string } = {
  ...
  [8453]: isProd ? '0x9fF4B2bB2F986e59CbDe711Db9FEf646Ec849Ad1' : '0xbA408B6a76068Cdd66EEC0432Fd4105C15eced90',
  [153]: '0x7A9298B45E6b2c3F53b7956c2B7A44d3857e8E90',
  [151]: '0xfAc6DbB5Df2763919694C409B67a9B3Abf150fc3',
}
...
export const FACTORY_ROUTER_ADDRESS: { [key: number]: string } = {
  ...
  [8453]: isProd ? '0x2eE28d1Bbc2EcB1fFDB83E8055d585E9F0fb757f' : '0x51CC508F1f4569073de51fe0Ef473E5E4E9BcdC0',
...
export const LBP_FACTORY_ADDRESS = {
  ...
  [8453]: isProd ? '0x887961318C007533f4e0b1559FA6bBce4415427E' : '0x63872f91dC88E44b61B991c73BEf8cC1672c3614',
} as Record<number, string>
